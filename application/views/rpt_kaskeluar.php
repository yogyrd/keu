...
?>
                    ...
                    <table>
                            ...
                            <td>
                                <div class="col-md-5">
                                    <select id="option" class="form-control">
                                        ...
                                        <option value="3">Pengajuan Belum Terealisasi</option>
                                        <option value="4">Pengajuan Terealisasi</option>
                        ...
                        if ($this->session->userdata('grp') < 4) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6">
                                        <select id="locid" class="form-control" required>
                            ...
                            <td>
                                <div class="col-md-4">
                                    <select id="tgloption" class="form-control" required>
                                        ...
                                        <option value="3">Tanggal Realisasi</option>
                                        <option value="4">Tanggal Reject</option>
                                    </select>
                                    <span class="help-block"></span>
                                </div>
                            </td>
    ...
    <script>
        function filter() {
            ...
            if (locid == "" || option =="" || tgloption == "" || tgl1 == "" || tgl2 == "") {
                alert('Form harus dilengkapi!!');
            }
            else if (tgl2 < tgl1) {
                alert('Tanggal awal harus lebih kecil dari tanggal akhir!!');
            } else {
                window.open('<?= base_url() . 'rpt_kaskeluar'; ?>' + '/filter?locid='+ locid + '&option=' + option + '&tgloption=' + tgloption + '&tgl1=' + tgl1 + '&tgl2=' +tgl2,"_blank");
            }
        }
    </script>
    <!-- /.row -->
