<?php
$admin_page_title = 'Realisasi Cabang';
            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                    <div class="panel-body">
                        <form action="<?= base_url('realisasi_cabang'); ?>" method="post">
                            <table class="table">
                                <tr>
                                ...
                                <tr>
                                    <td style="width:10%;" align="right">Transfer ke Bank</td>
                                    <td>
                                        <div class="col-sm-7">
                                            <input type="hidden" id="bank_idin" name="bankidin" />
                                            <input type="text" id="bank_idin_ac" class="form-control input-sm-5 input_ac" placeholder="isi nama bank/nomor rekening tujuan di sini..." value="" required />
                                            <span></span>
                                        </div>
                                    </td>
                                </tr>
                ...
                <form action="<?= base_url('realisasi_cabang/update_status'); ?>" method="post">
                    <input type="hidden" name="locid" value="<?= $locid; ?>"/>
                    <input type="hidden" name="bankidin" value="<?= $bankin; ?>"/>
                    <div class="panel-body">
                        <table id="tabel_trans_kas" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th width="15%">Dari Bank</th>
                                <th width="10%">Ke Bank</th>
                            ...
                            <?php foreach($list_trans as $info){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= $info->keterangan; ?> - <?= $info->nomorfaktur; ?>
                                    </td>
                                    <td><?= $info->jenis; ?></td>
                                    <td align="right">
                                        <?php $rp = number_format($info->nilaiuang,0,',','.'); echo 'Rp '.$rp;?>
                                    </td>
                                    <td align="right">
                                        <?php $rp = number_format($info->realisasi,0,',','.'); echo 'Rp '.$rp;?>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="pengajuan_<?= $id; ?>" value="<?= $info->pengajuan; ?>">
                                    </td>
                                    <td align="center">
                                        <label>
                ...
                <script>
                    ...
                    $("#bank_idin_ac").autocomplete({
                        ...
                        select: function( event, ui ) {
                            ...
                            $("#bank_idin").val(ui.item.id);
                            console.log(document.getElementById('bank_idin').value);
                    ...
                    $("#bank_idin_ac").blur(function () {
                        var a = document.getElementById('bank_idin').value;
                        if (!a) {
                            alert('Bank Tidak Tersedia!!');
                        }
                    });
