<?php
$admin_page_title = 'Approval Dir. Keuangan || Kas Pengeluaran';
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?= base_url('approval_3'); ?>" method="post">
                ...
                <form action="<?= base_url('approval_3/update_status'); ?>" method="post">
                    <div class="panel-body">
                        <table id="tabel_trans_kas" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th width="13%">Nilai Uang Pengajuan</th>
    ...
    <script type="text/javascript">
        ...
        function view_approved() {
            ...
            if (tgl1 > tgl2) {
                ...
                window.location.href="<?= base_url('approval_3/view_approved'); ?>?locid=" + loc + "&tgl1=" + tgl1 + "&tgl2=" + tgl2;
            }
        }
    </script>
    <!-- /.row -->
