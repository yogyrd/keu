<html>
    ...
    <body>
        <div class="header pagenum">
            ...
            <div class="judul-detail">Ditolak</div>
        ...
        <table class="tabel-content">
            ...
            <?php foreach ($list as $info) {  ?>
                <tr>
                    ...
                    <td align="right"><?php $rp = number_format($info->nilaiuang,0,',','.'); echo $rp;?></td>
                    <td align="center"><?= date('Y-m-d',strtotime($info->rejecteddate)); ?></td>
                    <td><?= $info->alasan; ?></td>
                </tr>
