<html>
    ...
    <body>
        <div class="header pagenum">
            ...
            <div class="judul-detail">Disetujui Kakanper</div>
        ...
        <table class="tabel-content">
            ...
            <tr>
                ...
                <th width="20%">Nominal Pengajuan</th>
            ...
            <?php foreach ($list as $info) {  ?>
                ...
                <?php $total=$total+$info->nilaiuang;$no++; ?>
            <?php  } ?>
            </tbody>
            <tfoot>
                <tr align="right">
                    ...
                    <th></th>
                    <th>TOTAL</th>
                    <th><?php $rp = number_format($total,2,',','.'); echo 'Rp '.$rp;?></th>
                </tr>
            </tfoot>
        </table>
